...
namespace Nuclear.TestSite.TestSuites {
    ...
    /// <summary>
    /// Provides conditional test instructions for files.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public partial class FileTestSuite : ChildTestSuite {

        #region ctors

        internal FileTestSuite(TestSuiteCollection parent) : base(parent) { }
